...
public class OrderServiceImplTest {
    ...
    private final String ORDER_ID = "20200224210002731495";

    @Test
    public void create() throws Exception{
        OrderDTO orderDTO = new OrderDTO();
        orderDTO.setBuyerAddress("昆明");
        orderDTO.setBuyerName("师傅");
        orderDTO.setBuyerPhone("18273877909");
